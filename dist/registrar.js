  ...
  (0, _createClass2["default"])(Registrar, [{
    ...
    value: function () {
      var _getAddress = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(name) {
        var ZERO_ADDRESS, provider, hash, resolverAddr, Resolver;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 16:
                ...
                console.log("Legacy entry error", _context5.t0);
                legacyEntry = {
                  deedOwner: '0x0',
                  state: 0,
                  registrationDate: 0,
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                contractAddress = '0x30aE79439ad599A142Ff16972626b2E1875Ad15d';
                _context13.next = 5;
        ...
        return _regenerator["default"].wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                _context14.prev = 0;
                return _context14.abrupt("return", this.getText('xdc', 'oracle'));
    ...
    return _regenerator["default"].wrap(function _callee32$(_context32) {
      while (1) {
        switch (_context32.prev = _context32.next) {
          case 0:
            _context32.next = 2;
            return ENS.resolver((0, _namehash.namehash)('xdc'));
      ...
      while (1) {
        switch (_context33.prev = _context33.next) {
          ...
          case 6:
            ...
            _context33.next = 9;
            return ENS.owner((0, _namehash.namehash)('xdc'));

          case 9:
            ethAddress = _context33.sent;
            console.log("ETH addrsss", ethAddress); // let ethAddress = "0x354267E84F96b4d743Dbe36A14024FFe6D876f34";
            // let controllerAddress = await Resolver.interfaceImplementer(
            //   namehash('xdc'),
            //   permanentRegistrarInterfaceId
            // )

            controllerAddress = "0xaC6234d93968c11B8983594083347f5C1e72f60a";
            console.log("Controller address", controllerAddress);
            _context33.next = 15;
            return Resolver.interfaceImplementer((0, _namehash.namehash)('xdc'), legacyRegistrarInterfaceId);

          case 15:
            legacyAuctionRegistrarAddress = _context33.sent;
            _context33.next = 18;
            return Resolver.interfaceImplementer((0, _namehash.namehash)('xdc'), bulkRenewalInterfaceId);
